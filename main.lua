...
function love.load()
	...
	IMG_turnip_die_left = love.graphics.newImage("assets/bird_die_left.png")
	IMG_turnip_die_right = love.graphics.newImage("assets/bird_die_right.png")
	IMG_turnip_ghost_left = love.graphics.newImage("assets/bird_ghost_left.png")
	IMG_turnip_ghost_right = love.graphics.newImage("assets/bird_ghost_right.png")
